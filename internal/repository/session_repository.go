...
type SessionRepository interface {
	...
	FindByID(ctx context.Context, id uuid.UUID) (*domain.AuthSession, error)
...
func (r *sessionRepository) FindByID(ctx context.Context, id uuid.UUID) (*domain.AuthSession, error) {
	query := `
